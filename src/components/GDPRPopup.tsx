    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      >
        ...
        <div className="max-h-[60vh] overflow-y-auto text-sm text-muted-foreground space-y-4">
          ...
          <p>
            Този сайт събира, обработва и използва само и единствено следните
            лични данни:
          </p>
          ...
          <p>
            Ние не използваме бисквитки (cookies) за съхранение на въведена от
            Вас информация.
          </p>

          <p>
            За да достъпите услугите, които предоставя сайтът, е необходимо
            доброволно да предоставите Вашето изрично съгласие за обработване на
            Вашите лични данни.
          </p>

          <p>
            За повече подробности, свързани с поверителността, можете да се
            запознаете с нашите Правила за защита на личните данни или да се
            свържете с нас на:
            <a
              href="mailto:info@moyatapensia.bg"
              className="text-primary underline ml-1"
            >
              info@moyatapensia.bg
            </a>
          </p>
        </div>
        <DialogFooter>
