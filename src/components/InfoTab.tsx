  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <Card className="border border-border/50 shadow-sm">
        <CardHeader>
          <CardTitle className="text-2xl font-medium">About Retirement Planning</CardTitle>
          <CardDescription>Learn more about planning for your retirement</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div>
            <h3 className="text-lg font-medium mb-2">Understanding Pension Funds</h3>
          ...
          <div>
            <h3 className="text-lg font-medium mb-2">How Our Calculator Works</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div>
            <h3 className="text-lg font-medium mb-2">Retirement Age in Bulgaria</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div>
            <h3 className="text-lg font-medium mb-2">Additional Pension Funds</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div>
            <h3 className="text-lg font-medium mb-2">Planning for the Future</h3>
            <p className="text-muted-foreground leading-relaxed">
