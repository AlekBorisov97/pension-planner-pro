            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Monday to Friday, 9:00 - 17:00</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">support@retirementplanner.bg</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Monday to Friday: 9:00 - 17:00</p>
            ...
            <div className="space-y-6">
              <div className="rounded-lg overflow-hidden border border-border h-[200px] relative">
                <div className="absolute inset-0 bg-muted flex items-center justify-center">
                  <p className="text-muted-foreground text-sm">Interactive map would appear here</p>
                </div>
              </div>
